...
class Translator:
    ...
    def _get_translator_key(self, localized_translator: str) -> str:
        ...
        translator_map = {
            ...
            self.settings.ui.tr("Grok-2"): "Grok-2",
            self.settings.ui.tr("Grok-2 Vision"): "Grok-2 Vision",
            self.settings.ui.tr("Grok-Vision-Beta"): "Grok-Vision-Beta",
            self.settings.ui.tr("Grok-Beta"): "Grok-Beta",
