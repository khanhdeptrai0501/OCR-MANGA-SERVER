...
class SettingsPageUI(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.credential_services = [self.tr("Custom"), self.tr("Deepseek"), self.tr("Open AI GPT"), self.tr("Microsoft Azure"), self.tr("Google Cloud"), 
                                    self.tr("Google Gemini"), self.tr("DeepL"), self.tr("Anthropic Claude"), self.tr("Yandex"), self.tr("Grok AI")]
        ...
        self.supported_translators = [self.tr("GPT-4o"), self.tr("GPT-4o mini"), self.tr("DeepL"), 
                                    ...
                                    self.tr("Gemini-2.0-Pro"), self.tr("Grok-2"), self.tr("Grok-2 Vision"), 
                                    self.tr("Grok-Vision-Beta"), self.tr("Grok-Beta"), self.tr("Yandex"), self.tr("Google Translate"),
        ...
        self.value_mappings = {
            ...
            self.tr("Grok-2"): "Grok-2",
            self.tr("Grok-2 Vision"): "Grok-2 Vision",
            self.tr("Grok-Vision-Beta"): "Grok-Vision-Beta",
            self.tr("Grok-Beta"): "Grok-Beta",
